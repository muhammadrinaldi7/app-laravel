<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse h-auto w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#kasir-nav" class="nav-link collapsed" aria-controls="applicationsExamples" role="button" aria-expanded="false">
          ...
          <div class="collapse" id="kasir-nav" style="">
            <ul class="nav ms-4 ps-3">
                <li class="nav-item">
                    <a class="nav-link" href="/penjualan/kasir">
                        <span class="sidenav-mini-icon"> K </span>
                        <span class="sidenav-normal"> Kasir</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/penjualan/pesanan">
        ...
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#applicationsExamples" class="nav-link" aria-controls="applicationsExamples" role="button" aria-expanded="true">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                  <div class="fa fa-inbox text-icon" style="width: 12px; height: 12px; font-size: 12px; color: #3a416d;" aria-hidden="true"></div>
              </div>
          ...
          <div class="collapse show" id="applicationsExamples" style="">
              <ul class="nav ms-4 ps-3">
                  ...
                  {{-- <li class="nav-item ">
                      <a class="nav-link " href="https://dev.unimasoft.id/sposerp/stok/pengeluaran">
                          <span class="sidenav-mini-icon"> P </span>
                          <span class="sidenav-normal"> Pengeluaran </span>
                      </a>
                  </li>
                  <li class="nav-item ">
                      <a class="nav-link " href="https://dev.unimasoft.id/sposerp/supplier">
                          <span class="sidenav-mini-icon"> S </span>
